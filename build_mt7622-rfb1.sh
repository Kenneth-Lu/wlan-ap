...
{
   echo ""
   echo "build_mt7622-rfb1.sh : This is the master script to build openwrt image for mt7622-rfb1 with opensync"
   echo "Syntax: ./build_mt7622-rfb1.sh [build|rebuild|help]"
   echo ""
   echo "Prerequisite:"
...
genConfig()
{
   ...
   cd $BUILD_DIR
   python$PY_VERSION $BUILD_DIR/scripts/gen_config.py mt7622-rfb1 wlan-ap-consumer wifi-mt76 || exit 1
   cd ..
}
